      ...
      >
        {primaryTabs.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex flex-col items-center justify-center flex-1 py-2 text-[11px] transition-colors relative ${
                active ? 'text-charcoal font-bold' : 'text-neutral-400 font-semibold'
              }`}
            >
              {active && (
        ...
        {moreTabs.length > 0 && (
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 py-2 text-[11px] transition-colors relative ${
              isMoreActive || moreOpen ? 'text-charcoal font-bold' : 'text-neutral-400 font-semibold'
            }`}
          >
